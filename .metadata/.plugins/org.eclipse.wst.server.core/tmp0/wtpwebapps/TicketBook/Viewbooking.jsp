...
<a href="AdminPage.html"><input class="button" type="submit" value="Admin"></a></header>
<%
try{
...
while(rs.next())
{
	...
	<td><%=rs.getString(10)%></td><td><a href="book.jsp?busid=<%=rs.getInt("busid")%>" class="btn-btn-denger"></a></td>
	</tr>
	<% 
}
out.println("</table>");
