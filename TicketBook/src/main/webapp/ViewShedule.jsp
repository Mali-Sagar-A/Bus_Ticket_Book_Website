...
out.println("<tr><td>busid</td><td>from</td><td>to</td><td>deprature</td><td>arival</td><td>date</td><td>busType</td><td>Price</td><td>Book</td></tr>");
while(rs.next())
{
	%>
	...
	<td><%=rs.getString(8)%></td><td><a href="book.jsp?busid=<%=rs.getInt("busid")%>" class="btn-btn-denger">Book Bus</a></td>
	</tr>
	<% 
}
out.println("</table>");
